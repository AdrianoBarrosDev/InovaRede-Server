...
import InovaRede.InovaRedeServer.repository.UserProjectRepository;
...
public class UserService {
    ...
    public UserService(UserRepository userRepository, ProjectRepository projectRepository, UserProjectRepository associateRepository) {
